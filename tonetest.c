/* clone of the nunchuckAimlab file, branched/copied the morning of demo day
 * to try and implement last minute features. Not yet tested (I don't have a pi anymore)
 */
...
void display_menu(void)
{
	...
	const char* press = "PRESS Z TO START";
